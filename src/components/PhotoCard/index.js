...
import { Article, Img, ImgWrapper, ToggleContainer,Capitalize } from './styles'
...
export const PhotoCard = ({ id = 0, liked, likes = 0, src = DEFAULT_IMAGE, comments, description, nombre, apellido }) => {
