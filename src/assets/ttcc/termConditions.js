...
const termConditions = [
    ...
    {
        subtitle: "2. ¿CÓMO JUGAR?",
        description: `
            Ingresá a la plataforma con tu DNI como USUARIO Y CONTRASEÑA.
            Subí una foto con tu familia: papás, hermanos, mascotas, amigos, pareja. Los seres más especiales en tu vida.
            Conseguí la mayor cantidad de likes en tu foto y ganá!!
            En la página principal encontrarás:
            a) El ranking de likes en tiempo real.
            b) Todas las fotos subidas de manera aleatoria.
        `
    },
    {
    ...
    {
        subtitle: "5. EMPATE AL FINAL DEL JUEGO",
        description: `
        En caso de empate (igualdad de likes en una foto) se posicionará primero quien haya subido primero su foto.
        Si ganás, el área de Clima Laboral se pondrá en contacto con vos para coordinar la entrega de tu premio.
        Cualquier duda y/o consulta podrás remitirlas al celular Enjoy: 351-2730512.
        `
    },
];
